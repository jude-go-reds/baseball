    ...
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap items-center gap-2 text-sm">
        <input
          ...
          className="min-w-0 flex-1 rounded-md border border-gray-300 bg-white px-3 py-2 text-base outline-none focus:border-gray-500 dark:border-gray-700 dark:bg-gray-900"
        />
        <select
          value={position}
          onChange={(e) => {
